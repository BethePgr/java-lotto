...
class BonusNumberValidationTest {
    ...
    void 에러_뜸() throws Exception {
        List<String> list = List.of("1", "2", "3", "4", "5", "6");
        assertThrows(IllegalArgumentException.class,()->BonusNumberValidation.validate("46",list));
    }

    @Test
    void 에러_뜸1() throws Exception {
        List<String> list = List.of("1", "2", "3", "4", "5", "6");
        assertThrows(IllegalArgumentException.class,()->BonusNumberValidation.validate("4",list));
    }
